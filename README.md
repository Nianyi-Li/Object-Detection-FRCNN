...
2. Run docker container:
   ...
   ```
   sudo  docker run --rm --runtime=nvidia -p 10000:10000 -it \
        -v /media/maciej/Nianyi/test_set/Object-Detection:/workspace \
        -v /media/maciej/Nianyi/test_set/Object-Detection/BBox/data_clean:/data \
        -v /home/maciej:/home/maciej detection-a bash
   ``` 
   Or
   ```
   sudo  docker run --rm --runtime=nvidia -p 10000:10000 -it \
        -v /home/nianyi/Documents/Object-Detection:/workspace \
        -v /home/nianyi/Documents/Object-Detection/BBox/data_clean:/data \
